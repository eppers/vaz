...
<title>Centrum rachunkowości - panel administracyjny</title>
...
<div class="nav-outer"> 
		...
		<div id="nav-right">
			...
			<a href="/admin/user/edit" style="margin:10px 0 0 5px;" class="showhide-account"><img src="/public/admin/img/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></a>
			<div class="nav-divider">&nbsp;</div>
			<a href="/admin/wyloguj" id="logout"><img src="/public/admin/img/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
		...
		<ul class="select">
                    <li>
                        <a href="/admin/box/all"><b>Boksy</b><!--[if IE 7]><!--></a><!--<![endif]-->
                    </li>
		</ul>
